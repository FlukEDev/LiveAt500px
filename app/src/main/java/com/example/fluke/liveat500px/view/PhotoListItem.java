package com.example.fluke.liveat500px.view;
...
import com.example.fluke.liveat500px.view.state.BundleSavedState;
...
public class PhotoListItem extends BaseCustomViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newHeightMeasureSpace = MeasureSpec.makeMeasureSpec(height,
                MeasureSpec.EXACTLY);
